...
const NewUserForm: React.FC = () => {
  ...
  const createNewUser = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
        const response = await axios.post(`${BaseURL}/api/e/users/new`, {username: username, password: password},{headers: {
  ...
  return (
    <>
      ...
      <div
        className="authorized-template__content new-user-page"
        style={{
          border: "0px",
          fontVariant: "inherit",
          margin: "0px",
      ...
      >
        ...
        >
          <div
            className="input new-user-page__input"
            style={{
              border: "0px",
              fontVariant: "inherit",
              margin: "0px",
